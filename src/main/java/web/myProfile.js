...
function sendupdatedata()
{
    ...
    //alert(objvehicle.model);
     ufirstname=document.getElementById("first").value;
     ulastname=document.getElementById("last").value;
     ucellno= document.getElementById("cellnumber").value;
     uemailid=document.getElementById("studentEmailId").value;
    //var upass= document.getElementById("password").value;
     uadd1= document.getElementById("addressLine1").value;
     uadd2= document.getElementById("addressLine2").value;
     ucity= document.getElementById("city").value;
     ustate= document.getElementById("state").value;
     uzipcode=document.getElementById("zipcode").value;
     uvehiclemodel=document.getElementById("VehicleModel").value;
    uvehiclenumber=document.getElementById("VehicleNumber").value;
     uvehiclecapacity= document.getElementById("vehicleCapacity").value;
     ugender=obj.gender;
    ...
    //http://localhost:8080/shareonwheels/v1/user/139

    $.ajax({
        type: "PUT",
        url:" http://localhost:8080/shareonwheels/v1/user/"+updateuserid+"",

        data: JSON.stringify(JSONsendupdatedata),
        contentType: "application/json",
        success: function (data) {

            updatetextfield();
            sessionStorage.setItem('updatedataJSON', JSON.stringify(JSONsendupdatedata)) ;
...
function updatetextfield()
{
    ...
    //JSONsendupdatedata.firstName
    updatedata= JSON.parse(sessionStorage.getItem('updatedataJSON'));

    document.getElementById("first").value=updatedata.firstName;
    document.getElementById("last").value=updatedata.lastName;
    document.getElementById("cellnumber").value=updatedata.phoneNumber;
    document.getElementById("studentEmailId").value=updatedata.emailAddress;
    //var upass= document.getElementById("password").value;
    document.getElementById("addressLine1").value=updatedata.addressLine1;
    document.getElementById("addressLine2").value=updatedata.addressLine2;
    document.getElementById("city").value=updatedata.city;
    document.getElementById("state").value=updatedata.state;
    document.getElementById("zipcode").value=updatedata.zipcode;
   // document.getElementById("VehicleModel").value=JSONsendupdatedata.vehiclemodel;
    //document.getElementById("VehicleNumber").value=JSONsendupdatedata.vehiclenumber;
    //document.getElementById("vehicleCapacity").value=JSONsendupdatedata.vehiclecapacity;
    updateflag=false;
}